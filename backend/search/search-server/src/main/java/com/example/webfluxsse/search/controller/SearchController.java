...
public class SearchController {
  ...
  @Operation(
      ...
      description =
          "Performs full-text search across event titles and descriptions using Elasticsearch. "
  ...
  public Flux<ServerSentEvent<Event>> searchSse(
    ...
    return searchService
        .searchEventsForUser(request.query(), request.userId())
  ...
  @Operation(
      ...
      description =
          "Performs full-text search using Server-Sent Events. "
  ...
  public Flux<ServerSentEvent<Event>> searchSseGet(
      @RequestParam(required = false) String query, @RequestParam String userId) {
    return searchService
        .searchEventsForUser(query, userId)
        .map(event -> ServerSentEvent.<Event>builder().data(event).build());
  }
}
