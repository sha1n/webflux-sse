...
class SearchPocIntegrationIT {
    ...
    void shouldFilterSearchResultsBasedOnUserPermissions() throws Exception {
        // Create two events
        EventEntity entity1 = eventRepository.save(EventMapper.toEntity(new Event(LocalDateTime.now(), "Public Event", "Available to user1")));
        EventEntity entity2 = eventRepository.save(EventMapper.toEntity(new Event(LocalDateTime.now(), "Private Event", "Available to user2")));
    ...
    void shouldReturnEmptyResultsForUserWithNoPermissions() throws Exception {
        // Create an event
        EventEntity entity = eventRepository.save(EventMapper.toEntity(new Event(LocalDateTime.now(), "Test Event", "Test content")));
