...
class StreamingSearchIT {
    ...
    void shouldStreamSearchResultsUsingNdjson() throws Exception {
        ...
        for (int i = 0; i < totalEvents; i++) {
            ...
            EventEntity savedEntity = eventRepository.save(EventMapper.toEntity(event));
    ...
    void shouldSearchWithSpacesInQuery() throws Exception {
        ...
        EventEntity entity1 = eventRepository.save(EventMapper.toEntity(event1));
        EventEntity entity2 = eventRepository.save(EventMapper.toEntity(event2));
        EventEntity entity3 = eventRepository.save(EventMapper.toEntity(event3));
    ...
    void shouldSearchExactPhraseWithQuotes() throws Exception {
        ...
        EventEntity entity2 = eventRepository.save(EventMapper.toEntity(event2));
        EventEntity entity3 = eventRepository.save(EventMapper.toEntity(event3));
        EventEntity entity4 = eventRepository.save(EventMapper.toEntity(event4));
