...
/**
 * UserEventPermission DTO - API contract for permission data exchange.
 * This is a pure data transfer object without any database annotations.
 */
public record UserEventPermission(
    Long id,
    Long eventId,
    String userId
) {
