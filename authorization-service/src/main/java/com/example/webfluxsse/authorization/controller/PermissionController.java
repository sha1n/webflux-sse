...
public class PermissionController {
    ...
    // NEW: Batch permission check endpoint for search-service
    @PostMapping("/batch-check")
    public Mono<BatchPermissionCheckResponse> batchCheckPermissions(@RequestBody BatchPermissionCheckRequest request) {
